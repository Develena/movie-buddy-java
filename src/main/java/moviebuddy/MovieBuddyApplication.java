...
public class MovieBuddyApplication {
     ...
     * 애플리케이션 추가 요구사항:
     * 
     * (완료) 1. XML 문서로 작성된 영화 메타데이터도 다룰 수 있게 기능을 확장하라 : loadMovies()
     * (완료) 2. 영화 메타데이터 위치를 변경할 수 있도록 하라 : 현재는 classpath(resources밑)
    ...
    public void run(String[] args) throws Exception {
        ...
        // command_3 : 개봉년도로 영화 검색:: ❯ releasedYearBy 2015
