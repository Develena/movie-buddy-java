...
//            e.printStackTrace();
            ...
            // try-catch로 runtime exception으로 바꿈.
        }

    }

    // xml 데이터의 root 엘리먼트 클래스 만들기.
    ...
    public static class MovieData{
        ...
        public Movie toMovie(){
            ...
            String watchedData = getWatchedDate();
            return Movie.of(title,genres, language, country, releaseYear, director, actors, imdbLink, watchedData);
        }
    }
}
